...
def deletar_flashcard(request, id):
    #tarefa de casa, fazer a validação de segurança(dica, usar o request.user)
...
def iniciar_desafio(request):
    if request.method == 'GET':
        ...
        #Pergunta: Se houver menos flash cards do que perguntas, dará erro? justifique
        # flashcards.count(), nos traz essa solução
...
def listar_desafio(request):
    ...
    #todo:desenvolver os status, tarefa de casa
